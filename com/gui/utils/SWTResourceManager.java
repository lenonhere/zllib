...
public class SWTResourceManager {
	...
	public static Image decorateImage(Image baseImage, Image decorator,
		...
		Map<Image, Image> decoratedMap = (Map<Image, Image>) cornerDecoratedImageMap
				.get(baseImage);
	...
	public static void disposeImages() {
		...
		for (int i = 0; i < m_decoratedImageMap.length; i++) {
			...
			if (cornerDecoratedImageMap != null) {
				...
				Map<Image, Map<Image, Image>> maps = (Map<Image, Map<Image, Image>>) cornerDecoratedImageMap
						.values();

				for (Map decoratedMap : maps.values()) {
					Map<Image, Image> map = (Map<Image, Image>) decoratedMap
							.values();
