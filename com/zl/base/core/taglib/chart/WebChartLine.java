...
public class WebChartLine
{
  public String generateLineChart(String paramString1, String paramString2, String paramString3, HttpSession paramHttpSession, PrintWriter paramPrintWriter, DefaultCategoryDataset paramDefaultCategoryDataset, int paramInt1, int paramInt2, Color paramColor1, Color paramColor2)
  {
    String str = null;
    try
    {
      JFreeChart localJFreeChart = ChartFactory.createLineChart(paramString1, paramString3, paramString2, paramDefaultCategoryDataset, PlotOrientation.VERTICAL, true, true, false);
 ...
 * Qualified Name:     com.zl.base.core.taglib.chart.WebChartLine
