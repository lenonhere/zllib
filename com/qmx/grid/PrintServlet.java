...
public class PrintServlet extends HttpServlet
{
  ...
  protected void exportToHtml(HttpServletRequest request, HttpServletResponse response)
  ...
  protected void exportToPdf(HttpServletRequest request, HttpServletResponse response) throws JRException, IOException
  {
    JasperPrint jasperPrint = compileToFill(request);
  ...
  protected void batchExportToHtml(HttpServletRequest request, HttpServletResponse response)
    throws JRException, IOException
  {
  ...
  protected JasperPrint batchCompileToFill(DesignBuilder builder, List captions, List results, Map parameters)
    throws JRException
  {
    JRDataSource dataSource = null;
    if ((results == null) || (results.size() == 0))
  ...
  protected void batchExportToPdf(HttpServletRequest request, HttpServletResponse response) throws JRException, IOException
  {
    ...
    throws IOException, ServletException
  {
    ...
    try
    {
      ...
      out
        .println("<span class=\"bnew\">生成报表时发生错误，请将以下错误信息发送给管理员，谢谢!</span>");
      out.println("<pre>");
